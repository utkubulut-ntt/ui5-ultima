...
import { ODataFunctionResponseSettings } from "{{UI5_PATH}}/types/odata/ODataFunctionResponse.types";
 ...
 */
export default class ODataFunctionResponse extends ManagedObject {
    ...
    constructor(settings: ODataFunctionResponseSettings) {
        super();
