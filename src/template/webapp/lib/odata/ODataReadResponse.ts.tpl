...
import { ODataReadResponseSettings } from "{{UI5_PATH}}/types/odata/ODataReadResponse.types";
 ...
 */
export default class ODataReadResponse extends ManagedObject {
    ...
    constructor(settings: ODataReadResponseSettings) {
        super();
    ...
    public getData<DataT extends Record<string, any> | Record<string, any>[] = Record<string, any> | Record<string, any>[]>() {
